...
public class diary1 extends Fragment {
    private static final String TAG = "diary1";
...
//        Toast.makeText(context, "onCreateView called.", Toast.LENGTH_LONG).show();
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.diary1, container, false);
    ...
    public void setWeather(String data) {
        if (data != null) {
            if (data.equals("맑음")) {
                ...
                Log.d("diary1", "Unknown weather string : " + data);
            }
        }
    }
    ...
    public void setWeatherIndex(int index) {
        if (index == 0) {
            ...
            Log.d("diary1", "Unknown weather index : " + index);
        }
    ...
    public void showPhotoCaptureActivity() {
        ...
        Uri fileUri = FileProvider.getUriForFile(context,"org.techtown.foryou.fileprovider", file);
        ...
        if (intent != null) {
            switch (requestCode) {
                ...
                case AppConstants.REQ_PHOTO_SELECTION:  // 사진을 앨범에서 선택하는 경우
                    ...
                    Uri selectedImage = intent.getData();                    String[] filePathColumn = {MediaStore.Images.Media.DATA};
